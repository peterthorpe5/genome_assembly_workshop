...
# usage: have to copy Seqpm to working directory. 

# cp ~/misc_python/perl_misc/create_EMBL_draw/Seq.pm ./

# EXAMPLE:  perl ~/misc_python/perl_misc/create_EMBL_draw/GFF_to_EMBL.pl ../../altered_name/Rp.v1_alt.fasta ../Rpa.v1_alt.gff > Rp.EMBL

#EXAMPLE:  perl ~/misc_python/perl_misc/create_EMBL_draw/GFF_to_EMBL.pl genome.fasta gene.gff > out.EMBL
