...
@thresholds = (200) unless @thresholds;
...
for my $threshold (@thresholds) {
    ...
    print "size"       ; for my $fastafile (@fastafiles) { print $d . $all_stats {$fastafile} {scaffold} { $threshold } {span}       }; print "\n";
...
png(paste(args[1],".png",sep=""),2700,900,res=400)
grid.newpage()
